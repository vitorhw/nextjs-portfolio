---
title: lawfy
description: Final submission to Harvard's CS50x Fall 2020. Lawfy is a platform that allows lawyers to connect with clients and provide status updates from cases. This is a full-stack project in Python that features Flask and SQLite. Counts with authentication, access control and security.
date: "2023-05-6"
repository: me50/vitorhw/tree/cs50/problems/2020/x/project
published: true
---
